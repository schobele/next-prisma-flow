...
export type TagWithPosts = TagWithRelations & {
  posts: NonNullable<TagWithRelations["posts"]>;
};
export type TagWithOrganization = TagWithRelations & {
  organization: NonNullable<TagWithRelations["organization"]>;
};
