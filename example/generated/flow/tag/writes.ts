...
import type { FlowTagWrite } from "./zod";
...
export function transformTagCreate(input: FlowTagWrite): Prisma.TagCreateInput {
  const result: any = {};
  ...
  return result as Prisma.TagCreateInput;
}

export function transformTagUpdate(
  input: Partial<FlowTagWrite>,
  ...
  return result as Prisma.TagUpdateInput;
}
