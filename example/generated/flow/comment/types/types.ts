...
export type CommentWithParent = CommentWithRelations & {
  parent: NonNullable<CommentWithRelations["parent"]>;
};
export type CommentWithReplies = CommentWithRelations & {
  replies: NonNullable<CommentWithRelations["replies"]>;
};
export type CommentWithOrganization = CommentWithRelations & {
  organization: NonNullable<CommentWithRelations["organization"]>;
};
