...
export type UserWithPosts = UserWithRelations & {
  posts: NonNullable<UserWithRelations["posts"]>;
};
export type UserWithComments = UserWithRelations & {
  comments: NonNullable<UserWithRelations["comments"]>;
};
