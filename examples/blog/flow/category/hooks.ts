 ...
 *   const { data, loading, error, createCategory, updateCategory, deleteCategory } = useCategoriesList();
 *
 ...
 * ```
 */
export function useCategoriesList(opts: { autoLoad?: boolean } = { autoLoad: true }) {
 ...
 *
 * @param {ModelType} [instance] - Category instance for update mode, undefined for create mode
