...
export interface UseTodoSmartFormOptions {
  mode?: 'create' | 'update';
...
export interface UseTodoSmartFormResult {
  // Mode detection
...
export function useTodoSmartForm({
  mode,
  initialData,
  id,
  autoDetectMode = true,
}: UseTodoSmartFormOptions = {}): UseTodoSmartFormResult {
  ...
  const field = useCallback((fieldName: keyof TodoCreateInput): TodoFieldConfig => {
  ...
  const setData = useCallback((newData: Partial<TodoCreateInput | TodoUpdateInput>) => {
...
export function useTodoCreateForm(initialData?: any) {
  return useTodoSmartForm({ 
    mode: 'create', 
    initialData, 
...
export function useTodoUpdateForm(id: string, initialData?: any) {
  return useTodoSmartForm({ 
    mode: 'update', 
    id, 
    initialData, 
