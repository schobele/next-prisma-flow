...
import type { Category, CategoryCreateInput, CategoryUpdateInput, CategoryFieldConfig } from "./types";
...
export function CategoryFormProvider({
	...
	const createForm = useCreateCategoryForm(isCreateMode ? filteredInitialData : undefined);

	const updateForm = useUpdateCategoryForm(updateId, isUpdateMode ? filteredInitialData : undefined);
	...
	const setData = useCallback(
		(newData: Partial<CategoryCreateInput | CategoryUpdateInput>) => {
	...
	return <CategoryFormContext.Provider value={contextValue}>{children}</CategoryFormContext.Provider>;
}
...
export function useCategoryField(fieldName: keyof CategoryCreateInput): CategoryFieldConfig {
	...
	const createForm = useCreateCategoryForm(!isUpdateMode ? (context.data as Partial<CategoryCreateInput>) : undefined);
