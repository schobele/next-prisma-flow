...
// Generated at: 2025-06-06T18:13:19.634Z
...
import { baseUsersAtom, usersLoadingAtom, usersErrorAtom } from "./user/atoms";
import { baseCategoriesAtom, categoriesLoadingAtom, categoriesErrorAtom } from "./category/atoms";
import { baseTodosAtom, todosLoadingAtom, todosErrorAtom } from "./todo/atoms";
...
export function FlowProvider({
	...
	const handleError = useMemo(
		() => (error: Error, context: string, modelName?: string) => {
		...
		<FlowContext.Provider value={contextValue}>
			<JotaiProvider store={store}>
				{config.errorBoundary ? (
					<FlowErrorBoundary ref={errorBoundaryRef} onError={handleError} fallback={config.errorFallback}>
...
function DefaultErrorFallback({ error, reset }: { error: Error; reset: () => void }) {
	return (
		...
		>
			<h2 style={{ margin: "0 0 1rem 0", fontSize: "1.25rem", fontWeight: "bold" }}>Something went wrong</h2>
