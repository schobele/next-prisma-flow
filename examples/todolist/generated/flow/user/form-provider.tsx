...
import type { User, UserCreateInput, UserUpdateInput, UserFieldConfig } from "./types";
...
export function UserFormProvider({ children, mode, initialData, id, autoDetectMode = true }: UserFormProviderProps) {
	...
	const createForm = useCreateUserForm(isCreateMode ? filteredInitialData : undefined);

	const updateForm = useUpdateUserForm(updateId, isUpdateMode ? filteredInitialData : undefined);
	...
	const setData = useCallback(
		(newData: Partial<UserCreateInput | UserUpdateInput>) => {
...
export function useUserField(fieldName: keyof UserCreateInput): UserFieldConfig {
	...
	const createForm = useCreateUserForm(!isUpdateMode ? (context.data as Partial<UserCreateInput>) : undefined);
