...
// Generated at: 2025-06-06T18:13:19.630Z
...
export const refreshUsersAtom = atom(null, async (_get, set) => {
...
export const userByIdAtom = (id: string) =>
	atom((get) => {
		const usersMap = get(baseUsersAtom);
	...
	async (get, set, userData: Parameters<typeof UserActions.createUser>[0]) => {
		...
		const scalarFields = Object.fromEntries(
			Object.entries(userData).filter(
				([key, value]) => typeof value !== "object" || value instanceof Date || value === null,
			),
		);
...
export const optimisticDeleteUserAtom = atom(null, async (get, set, id: string) => {
