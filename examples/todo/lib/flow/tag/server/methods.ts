...
export async function create(
  ...
  const result = (await prisma.tag.create({
    select: TagSelect,
    ...args,
    data: deepMergePrismaData(args.data, policy.data || {}, "Tag"),
  })) as FlowTag;
...
export async function createMany(
  ...
  const data = Array.isArray(args.data)
    ? args.data.map((item) =>
        deepMergePrismaData(item, policy.data || {}, "Tag"),
      )
...
export async function upsert(
  ...
  return prisma.tag.upsert({
    ...
    create: deepMergePrismaData(args.create, createPolicy.data || {}, "Tag"),
    update: deepMergePrismaData(args.update, updatePolicy.data || {}, "Tag"),
  }) as Promise<FlowTag>;
}
