...
export async function create(args: Prisma.ListCreateArgs, ctx: FlowCtx = {}) {
...
export async function update(args: Prisma.ListUpdateArgs, ctx: FlowCtx = {}) {
...
export async function upsert(args: Prisma.ListUpsertArgs, ctx: FlowCtx = {}) {
